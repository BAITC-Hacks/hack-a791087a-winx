...
var sr = /*@__PURE__*/ new K(), cr = /*@__PURE__*/ new G(), lr = 0, ur = class extends $e {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: lr++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = Ve, this.updateRanges = [], this.gpuType = _, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
...
}, vr = 0, yr = /*@__PURE__*/ new Jt(), br = /*@__PURE__*/ new Sn(), xr = /*@__PURE__*/ new K(), Sr = /*@__PURE__*/ new Kn(), Cr = /*@__PURE__*/ new Kn(), wr = /*@__PURE__*/ new K(), Tr = class e extends $e {
	constructor() {
	...
	setIndex(e) {
		return this.index = Array.isArray(e) ? new (Ue(e) ? fr : dr)(e, 1) : e, this;
	}
	setIndirect(e, t = 0) {
...
}, Er = /*@__PURE__*/ new K(), Dr = /*@__PURE__*/ new K(), Or = /*@__PURE__*/ new q(), kr = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = Er.subVectors(n, t).cross(Dr.subVectors(e, t)).normalize();
	...
	applyMatrix4(e, t) {
		let n = t || Or.getNormalMatrix(e), r = this.coplanarPoint(Er).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, Ar = 0, jr = class extends $e {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Ar++ }), this.uuid = it(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Y(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Be, this.stencilZFail = Be, this.stencilZPass = Be, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, Mr = /*@__PURE__*/ new K(), Nr = /*@__PURE__*/ new K(), Pr = /*@__PURE__*/ new K(), Fr = /*@__PURE__*/ new K(), Ir = class {
	...
	distanceSqToSegment(e, t, n, r) {
		Nr.copy(e).add(t).multiplyScalar(.5), Pr.copy(t).sub(e).normalize(), Fr.copy(this.origin).sub(Nr);
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(Pr), o = Fr.dot(this.direction), s = -Fr.dot(Pr), c = Fr.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
		if (l > 0) {
		...
		return n && n.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(Nr).addScaledVector(Pr, d), f;
	}
	intersectSphere(e, t) {
		if (e.radius < 0) return null;
		Mr.subVectors(e.center, this.origin);
		let n = Mr.dot(this.direction), r = Mr.dot(Mr) - n * n, i = e.radius * e.radius;
		if (r > i) return null;
	...
	intersectTriangle(e, t, n, r, i) {
		...
		let M = S / w, N = C / w, P = 1 / w, ne = T - M * D, F = E - N * D, re = O - M * A, ie = k - N * A, ae = j - M * te, oe = ee - N * te, se = ae * ie - oe * re, I = ne * oe - F * ae, ce = re * F - ie * ne;
		if (r) {
			if (se < 0 || I < 0 || ce < 0) return null;
		} else if ((se < 0 || I < 0 || ce < 0) && (se > 0 || I > 0 || ce > 0)) return null;
		let le = se + I + ce;
		if (le === 0) return null;
		let ue = P * (se * D + I * A + ce * te);
		return (le > 0 ? ue < 0 : ue > 0) ? null : this.at(ue / le, i);
	}
	applyMatrix4(e) {
...
}, Rr = /*@__PURE__*/ new Jt(), zr = /*@__PURE__*/ new Ir(), Br = /*@__PURE__*/ new _r(), Vr = /*@__PURE__*/ new K(), Hr = /*@__PURE__*/ new K(), Ur = /*@__PURE__*/ new K(), Wr = /*@__PURE__*/ new K(), Gr = /*@__PURE__*/ new K(), Kr = /*@__PURE__*/ new K(), qr = /*@__PURE__*/ new K(), Jr = /*@__PURE__*/ new K(), Yr = class extends Sn {
	constructor(e = new Tr(), t = new Lr()) {
...
function Zr(e, t, n, r, i, a, o, s, c, l) {
	...
	if (u) {
		let e = new K();
		Gn.getBarycoord(qr, Hr, Ur, Wr, e), i && (u.uv = Gn.getInterpolatedAttribute(i, s, c, l, e, new G())), a && (u.uv1 = Gn.getInterpolatedAttribute(a, s, c, l, e, new G())), o && (u.normal = Gn.getInterpolatedAttribute(o, s, c, l, e, new K()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Gn.getNormal(Hr, Ur, Wr, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var Qr = class extends Ht {
...
}, $r = /*@__PURE__*/ new _r(), ei = /*@__PURE__*/ new G(.5, .5), ti = /*@__PURE__*/ new K(), ni = class {
	constructor(e = new kr(), t = new kr(), n = new kr(), r = new kr(), i = new kr(), a = new kr()) {
		this.planes = [
			e,
			t,
			n,
	...
	intersectsObject(e) {
		if (e.boundingSphere !== void 0) e.boundingSphere === null && e.computeBoundingSphere(), $r.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
		else {
			let t = e.geometry;
	...
	intersectsSprite(e) {
		return $r.center.set(0, 0, 0), $r.radius = .7071067811865476 + ei.distanceTo(e.center), $r.applyMatrix4(e.matrixWorld), this.intersectsSphere($r);
	}
	intersectsSphere(e) {
...
}, ii = /*@__PURE__*/ new K(), ai = /*@__PURE__*/ new K(), oi = /*@__PURE__*/ new Jt(), si = /*@__PURE__*/ new Ir(), ci = /*@__PURE__*/ new _r(), li = /*@__PURE__*/ new K(), ui = /*@__PURE__*/ new K(), di = class extends Sn {
	constructor(e = new Tr(), t = new ri()) {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			for (let e = 1, r = t.count; e < r; e++) ii.fromBufferAttribute(t, e - 1), ai.fromBufferAttribute(t, e), n[e] = n[e - 1], n[e] += ii.distanceTo(ai);
	...
	raycast(e, t) {
		...
		if (l !== null) {
			...
			for (let i = n, a = r - 1; i < a; i += c) {
				let n = l.getX(i), r = l.getX(i + 1), a = fi(this, e, si, s, n, r, i);
				a && t.push(a);
			}
			if (this.isLineLoop) {
				let i = l.getX(r - 1), a = l.getX(n), o = fi(this, e, si, s, i, a, r - 1);
				o && t.push(o);
			}
		} else {
			let n = Math.max(0, a.start), r = Math.min(u.count, a.start + a.count);
			for (let i = n, a = r - 1; i < a; i += c) {
				let n = fi(this, e, si, s, i, i + 1, i);
				n && t.push(n);
			}
			if (this.isLineLoop) {
				let i = fi(this, e, si, s, r - 1, n, r - 1);
				i && t.push(i);
			}
		}
	}
...
function fi(e, t, n, r, i, a, o) {
	...
	if (ii.fromBufferAttribute(s, i), ai.fromBufferAttribute(s, a), n.distanceSqToSegment(ii, ai, li, ui) > r) return;
	li.applyMatrix4(e.matrixWorld);
	let c = t.ray.origin.distanceTo(li);
	if (!(c < t.near || c > t.far)) return {
		distance: c,
		point: ui.clone().applyMatrix4(e.matrixWorld),
		index: o,
		face: null,
		faceIndex: null,
		barycoord: null,
...
var pi = /*@__PURE__*/ new K(), mi = /*@__PURE__*/ new K(), hi = class extends di {
	constructor(e, t) {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			for (let e = 0, r = t.count; e < r; e += 2) pi.fromBufferAttribute(t, e), mi.fromBufferAttribute(t, e + 1), n[e] = e === 0 ? 0 : n[e - 1], n[e + 1] = n[e] + pi.distanceTo(mi);
			e.setAttribute("lineDistance", new pr(n, 1));
	...
	constructor(e = [], t = [], n = 1, r = 0) {
		...
		let i = [], a = [];
		o(r), c(n), l(), this.setAttribute("position", new pr(i, 3)), this.setAttribute("normal", new pr(i.slice(), 3)), this.setAttribute("uv", new pr(a, 2)), r === 0 ? this.computeVertexNormals() : this.normalizeNormals();
		function o(e) {
...
}, Si = /*@__PURE__*/ new K(), Ci = /*@__PURE__*/ new K(), wi = /*@__PURE__*/ new K(), Ti = /*@__PURE__*/ new Gn(), Ei = class extends Tr {
		...
		if (super(), this.type = "EdgesGeometry", this.parameters = {
			...
			for (let e = 0; e < o; e += 3) {
				...
				if (t.fromBufferAttribute(a, s[0]), o.fromBufferAttribute(a, s[1]), f.fromBufferAttribute(a, s[2]), Ti.getNormal(wi), l[0] = `${Math.round(t.x * n)},${Math.round(t.y * n)},${Math.round(t.z * n)}`, l[1] = `${Math.round(o.x * n)},${Math.round(o.y * n)},${Math.round(o.z * n)}`, l[2] = `${Math.round(f.x * n)},${Math.round(f.y * n)},${Math.round(f.z * n)}`, l[0] !== l[1] && l[1] !== l[2] && l[2] !== l[0]) for (let e = 0; e < 3; e++) {
					let t = (e + 1) % 3, n = l[e], i = l[t], a = Ti[c[e]], o = Ti[c[t]], f = `${n}_${i}`, p = `${i}_${n}`;
					p in u && u[p] ? (wi.dot(u[p].normal) <= r && (d.push(a.x, a.y, a.z), d.push(o.x, o.y, o.z)), u[p] = null) : f in u || (u[f] = {
						index0: s[e],
						index1: s[t],
						normal: wi.clone()
					});
			...
			for (let e in u) if (u[e]) {
				...
				Si.fromBufferAttribute(a, t), Ci.fromBufferAttribute(a, n), d.push(Si.x, Si.y, Si.z), d.push(Ci.x, Ci.y, Ci.z);
			}
...
function ki(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (ji(i)) i.isRenderTargetTexture ? (H("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
var Qi = class {
	...
	scale(e) {
		if (e !== 1) {
			let t = this.times;
			for (let n = 0, r = t.length; n !== r; ++n) t[n] *= e;
			Ui(this.settings) && ($i(this.settings.inTangents, e), $i(this.settings.outTangents, e));
		}
		return this;
	}
	trim(e, t) {
...
Qi.prototype.ValueTypeName = "", Qi.prototype.TimeBufferType = Float32Array, Qi.prototype.ValueBufferType = Float32Array, Qi.prototype.DefaultInterpolation = R;
var ea = class extends Qi {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
ea.prototype.ValueTypeName = "bool", ea.prototype.ValueBufferType = Array, ea.prototype.DefaultInterpolation = Me, ea.prototype.InterpolantFactoryMethodLinear = void 0, ea.prototype.InterpolantFactoryMethodSmooth = void 0;
...
aa.prototype.ValueTypeName = "string", aa.prototype.ValueBufferType = Array, aa.prototype.DefaultInterpolation = Me, aa.prototype.InterpolantFactoryMethodLinear = void 0, aa.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var sa = class extends Sn {
...
}, la = /*@__PURE__*/ new Jt(), ua = /*@__PURE__*/ new K(), da = /*@__PURE__*/ new K(), fa = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new G(512, 512), this.mapType = d, this.map = null, this.mapPass = null, this.matrix = new Jt(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new ni(), this._frameExtents = new G(1, 1), this._viewportCount = 1, this._viewports = [new Ut(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		let t = this.camera;
		ua.setFromMatrixPosition(e.matrixWorld), t.position.copy(ua), da.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(da), t.updateMatrixWorld(), this._updateMatrix(t, this.matrix, this._frustum);
	}
	_updateMatrix(e, t, n, r) {
		la.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse), n.setFromProjectionMatrix(la, e.coordinateSystem, e.reversedDepth);
		let i = this._frameExtents, a = r ? r.z / i.x : 1, o = r ? r.w / i.y : 1, s = r ? r.x / i.x : 0, c = r ? r.y / i.y : 0;
		e.coordinateSystem === 2001 || e.reversedDepth ? t.set(.5 * a, 0, 0, .5 * a + s, 0, .5 * o, 0, .5 * o + c, 0, 0, 1, 0, 0, 0, 0, 1) : t.set(.5 * a, 0, 0, .5 * a + s, 0, .5 * o, 0, .5 * o + c, 0, 0, .5, .5, 0, 0, 0, 1), t.multiply(la);
	}
	getViewport(e) {
...
}, pa = /*@__PURE__*/ new K(), ma = /*@__PURE__*/ new Et(), ha = /*@__PURE__*/ new K(), ga = class extends Sn {
	constructor() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(pa, ma, ha), ha.x === 1 && ha.y === 1 && ha.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(pa, ma, ha.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(pa, ma, ha), ha.x === 1 && ha.y === 1 && ha.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(pa, ma, ha.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, _a = /*@__PURE__*/ new K(), va = /*@__PURE__*/ new G(), ya = /*@__PURE__*/ new G(), ba = class extends ga {
	...
	getViewBounds(e, t, n) {
		_a.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(_a.x, _a.y).multiplyScalar(-e / _a.z), _a.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(_a.x, _a.y).multiplyScalar(-e / _a.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, va, ya), t.subVectors(ya, va);
	}
	...
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(Sn.DEFAULT_UP), this.updateMatrix(), this.target = new Sn(), this.shadow = new Sa();
	}
	dispose() {
...
}, wa = -90, Ta = 1, Ea = class extends Sn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new ba(wa, Ta, e, t);
		r.layers = this.layers, this.add(r);
		let i = new ba(wa, Ta, e, t);
		i.layers = this.layers, this.add(i);
		let a = new ba(wa, Ta, e, t);
		a.layers = this.layers, this.add(a);
		let o = new ba(wa, Ta, e, t);
		o.layers = this.layers, this.add(o);
		let s = new ba(wa, Ta, e, t);
		s.layers = this.layers, this.add(s);
		let c = new ba(wa, Ta, e, t);
...
var Ba = /*@__PURE__*/ new Jt(), Va = class {
	constructor(e, t, n = 0, r = Infinity) {
		this.ray = new Ir(e, t), this.near = n, this.far = r, this.camera = null, this.layers = new on(), this.params = {
			Mesh: {},
			Line: { threshold: 1 },
			LOD: {},
			Points: { threshold: 1 },
	...
	setFromXRController(e) {
		return Ba.identity().extractRotation(e.matrixWorld), this.ray.origin.setFromMatrixPosition(e.matrixWorld), this.ray.direction.set(0, 0, -1).applyMatrix4(Ba), this;
	}
	intersectObject(e, t = !0, n = []) {
		return Ua(e, this, n, t), n.sort(Ha), n;
	}
	intersectObjects(e, t = !0, n = []) {
		for (let r = 0, i = e.length; r < i; r++) Ua(e[r], this, n, t);
		return n.sort(Ha), n;
	}
};
function Ha(e, t) {
...
function Ua(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) Ua(r[e], t, n, !0);
	}
}
var Wa = class {
...
var X = {
	...
	points: {
		uniforms: /*@__PURE__*/ Ai([Z.points, Z.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ Ai([Z.common, Z.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ Ai([Z.sprite, Z.fog]),
...
Xa.physical = {
	uniforms: /*@__PURE__*/ Ai([Xa.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Za = {
	...
	b: 0,
	g: 0
}, Qa = /*@__PURE__*/ new Jt(), $a = /*@__PURE__*/ new q();
...
function eo(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Yr(new bi(1, 1, 1), new Li({
			name: "BackgroundCubeMaterial",
			uniforms: ki(Xa.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(Qa.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply($a), l.material.toneMapped = J.getTransfer(i.colorSpace) !== ze, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Yr(new Oi(2, 2), new Li({
			name: "BackgroundMaterial",
			uniforms: ki(Xa.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(Za, Ni(e)), n.buffers.color.setClear(Za.r, Za.g, Za.b, r, a);
	}
	function _() {
...
function io(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new kr(), s = new q(), c = {
		value: null,
		needsUpdate: !1
	};
...
var ao = 4, oo = 6, so = 20, co = 256, lo = /*@__PURE__*/ new xa(), uo = /*@__PURE__*/ new Y(), fo = null, po = 0, mo = 0, ho = !1, go = /*@__PURE__*/ new K(), _o = /*@__PURE__*/ new K(), vo = class {
	constructor(e) {
	...
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		...
		fo = this._renderer.getRenderTarget(), po = this._renderer.getActiveCubeFace(), mo = this._renderer.getActiveMipmapLevel(), ho = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(fo, po, mo), this._renderer.xr.enabled = ho, e.scissorTest = !1, xo(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), fo = this._renderer.getRenderTarget(), po = this._renderer.getActiveCubeFace(), mo = this._renderer.getActiveMipmapLevel(), ho = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods} = yo(r)), this._blurMaterial = Co(r, e, t), this._ggxMaterial = So(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Yr(new Tr(), e);
		this._renderer.compile(t, lo);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new ba(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(uo), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Yr(new bi(), new Lr({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(uo), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
	...
	_textureToCubeUV(e, t) {
		...
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = To()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = wo());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		xo(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, lo);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - ao ? n - d + ao : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, xo(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, lo), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, xo(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, lo);
	}
	_blur(e, t, n, r) {
	...
	_blurPass(e, t, n, r, i) {
		...
		xo(t, 3 * l * (r > this._lodMax - ao ? r - this._lodMax + ao : 0), 4 * (this._cubeSize - l), 3 * l, 2 * l), a.setRenderTarget(t), a.render(s, lo);
	}
};
function yo(e) {
	let t = [], n = [], r = e, i = e - ao + 1 + oo;
	for (let e = 0; e < i; e++) {
		let e = 2 ** r;
		t.push(e);
		...
		for (let e = 0; e < 6; e++) {
			...
			for (let t = 0; t < 6; t++) {
				...
				e === 0 ? _o.set(1, r, n) : e === 1 ? _o.set(-n, 1, -r) : e === 2 ? _o.set(-n, r, 1) : e === 3 ? _o.set(-1, r, -n) : e === 4 ? _o.set(-n, -1, r) : _o.set(n, r, -1), _o.toArray(l, (e * 6 + t) * 3);
			}
		}
		let u = new Tr();
		u.setAttribute("position", new ur(c, 3)), u.setAttribute("outputDirection", new ur(l, 3)), n.push(new Yr(u, null)), r > ao && r--;
	}
	return {
		lodMeshes: n,
		sizeLods: t
...
var Do = class extends Gt {
	constructor(e = 1, t = {}) {
		...
		this.texture = new gi(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		return t.minFilter === 1008 && (t.minFilter = c), new Ea(1, 10, this).update(e, a), t.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new vo(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new vo(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function Io(e, t, n, r, i, a) {
	...
	l.setAttribute("position", new pr([
		-1,
		3,
		0,
		-1,
	...
	let u = new Ri({
		...
		depthTest: !1,
		depthWrite: !1
	}), d = new Yr(l, u), f = new xa(-1, 1, 1, -1, 0, 1), p = null, m = null, h = !1, g, _ = null, y = [], b = !1;
...
var Lo = /*@__PURE__*/ new Ht(), Ro = /*@__PURE__*/ new _i(1, 1), zo = /*@__PURE__*/ new Kt(), Bo = /*@__PURE__*/ new qt(), Vo = /*@__PURE__*/ new gi(), Ho = [], Uo = [], Wo = /* @__PURE__ */ new Float32Array(16), Go = /* @__PURE__ */ new Float32Array(9), Ko = /* @__PURE__ */ new Float32Array(4);
function qo(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Ho[i];
...
function Xo(e, t) {
	let n = Uo[t];
	n === void 0 && (n = new Int32Array(t), Uo[t] = n);
...
function ts(e, t) {
	...
	if (r === void 0) {
		...
		if (Jo(n, r)) return;
		Ko.set(r), e.uniformMatrix2fv(this.addr, !1, Ko), Yo(n, r);
	}
}
function ns(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Jo(n, r)) return;
		Go.set(r), e.uniformMatrix3fv(this.addr, !1, Go), Yo(n, r);
	}
}
function rs(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Jo(n, r)) return;
		Wo.set(r), e.uniformMatrix4fv(this.addr, !1, Wo), Yo(n, r);
	}
}
function is(e, t) {
	let n = this.cache;
...
function fs(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (Ro.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = Ro) : a = Lo, n.setTexture2D(t || a, i);
}
function ps(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
...
function hs(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || zo, i);
}
function gs(e) {
	switch (e) {
		case 5126: return Zo;
...
function vs(e, t) {
	let n = qo(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function ys(e, t) {
	let n = qo(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function bs(e, t) {
	let n = qo(t, this.size, 4);
...
function Ss(e, t) {
	let n = qo(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function Cs(e, t) {
	let n = qo(t, this.size, 16);
...
function Ms(e, t, n) {
	...
	Jo(r, a) || (e.uniform1iv(this.addr, a), Yo(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? Ro : Lo;
...
function Fs(e, t, n) {
	let r = this.cache, i = t.length, a = Xo(n, i);
	Jo(r, a) || (e.uniform1iv(this.addr, a), Yo(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || zo, a[e]);
}
function Is(e) {
	switch (e) {
		case 5126: return _s;
...
var Ls = class {
	...
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = Is(t.type);
	}
}, zs = class {
	constructor(e) {
...
function Hs(e, t, n) {
	...
	for (Bs.lastIndex = 0;;) {
		...
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Vs(n, l === void 0 ? new Ls(s, e, t) : new Rs(s, e, t));
			break;
		}
		{
			let e = n.map[s];
			e === void 0 && (e = new zs(s), Vs(n, e)), n = e;
		}
	}
}
var Us = class {
...
var Js = /*@__PURE__*/ new q();
function Ys(e) {
	J._getMatrix(Js, J.workingColorSpace, e);
	let t = `mat3( ${Js.elements.map((e) => e.toFixed(4))} )`;
...
var ec = /*@__PURE__*/ new K();
function tc() {
	return J.getLuminanceCoefficients(ec), [
...
var fc = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function pc(e) {
	return e.replace(fc, mc);
}
function mc(e, t, n, r) {
	let i = "";
...
function yc(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : vc[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
...
function Cc(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : Sc[e.combine] || "ENVMAP_BLENDING_NONE";
}
function wc(e) {
...
function Tc(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = _c(n), l = yc(n), u = xc(n), d = Cc(n), f = wc(n), p = nc(n), m = rc(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : $s("toneMapping", n.toneMapping),
		n.dithering ? "#define DITHERING" : "",
		n.opaque ? "#define OPAQUE" : "",
		X.colorspace_pars_fragment,
		Zs("linearToOutputTexel", n.outputColorSpace),
		tc(),
	...
	function C(t) {
		...
		i.deleteShader(x), i.deleteShader(S), w = new Us(i, h), T = ic(i, h);
	}
	let w;
	...
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = Ks++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var Ec = 0, Dc = class {
	constructor() {
...
function Ac(e, t, n, r, i, a) {
	...
	function h(i, o, l, u, h, g) {
		...
		let Ne = {
			...
			packedNormalMap: ae && i.normalMapType === 0 && kc(i.normalMap.format),
			metalnessMap: I,
			roughnessMap: ce,
			anisotropy: le,
			anisotropyMap: ge,
			...
			extensionMultiDraw: (Me && i.extensions.multiDraw === !0 || M) && n.has("WEBGL_multi_draw"),
	...
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new Tc(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function Pc() {
	...
	function u(e, t) {
		n.length > 1 && n.sort(e || Mc), r.length > 1 && r.sort(t || Nc), i.length > 1 && i.sort(t || Nc);
	}
	function d() {
...
function Fc() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new Pc(), e.set(t, [i])) : n >= r.length ? (i = new Pc(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
var Uc = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Wc = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", Gc = [
	...
	/*@__PURE__*/ new K(0, -1, 0),
	/*@__PURE__*/ new K(0, -1, 0)
], qc = /*@__PURE__*/ new Jt(), Jc = /*@__PURE__*/ new K(), Yc = /*@__PURE__*/ new K();
function Xc(e, t, n) {
	let r = new ni(), i = new G(), o = new G(), s = new Ut(), l = new Bi(), u = new Vi(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, m = new Li({
			...
			if (p.camera._reversedDepth = b, p.map === null || h === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new Gt(i.x, i.y, {
						...
						magFilter: c,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new _i(i.x, i.y, _), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = D, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a;
				} else d.isPointLight ? (p.map = new Do(i.x), p.map.depthTexture = new vi(i.x, g)) : (p.map = new Gt(i.x, i.y), p.map.depthTexture = new _i(i.x, i.y, g)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = D, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = c, p.map.depthTexture.magFilter = c) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a);
		...
		if (t.samples > 0) {
			if (je(t) === !1) {
				...
				for (let l = 0; l < n.length; l++) {
					...
					e.blitFramebuffer(0, 0, r, i, 0, 0, r, i, a, e.NEAREST), _ === !0 && (De.length = 0, Oe.length = 0, De.push(e.COLOR_ATTACHMENT0 + l), t.depthBuffer && t.storeMultisampledDepthBuffer === !1 && (De.push(o), Oe.push(o), e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER, Oe)), e.invalidateFramebuffer(e.READ_FRAMEBUFFER, De));
				}
...
var el = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", tl = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", nl = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new Yr(new Oi(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, f = null, p = null, m = null, h = typeof XRWebGLBinding < "u", _ = new nl(), v = {}, y = t.getContextAttributes(), b = null, S = null, C = [], w = [], T = new G(), k = null, A = null, j = new ba();
		j.viewport = new Ut();
		let ee = new ba();
		ee.viewport = new Ut();
		let te = [j, ee], M = new Da(), N = null, P = null;
		...
		function F() {
			...
			if (e.setRenderTarget(b), p = null, f = null, u = null, r = null, S = null, ue.stop(), n.isPresenting = !1, e.setPixelRatio(k), e.setSize(T.width, T.height, !1), A !== null) {
				let e = A.camera;
			...
			if (r = l, r !== null) {
				if (b = e.getRenderTarget(), r.addEventListener("select", ne), r.addEventListener("selectstart", ne), r.addEventListener("selectend", ne), r.addEventListener("squeeze", ne), r.addEventListener("squeezestart", ne), r.addEventListener("squeezeend", ne), r.addEventListener("end", F), r.addEventListener("inputsourceschange", re), y.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(T), h && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					u = this.getBinding(), f = u.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new Gt(f.textureWidth, f.textureHeight, {
						format: E,
						type: d,
						depthTexture: new _i(f.textureWidth, f.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
...
}, il = /*@__PURE__*/ new Jt(), al = /*@__PURE__*/ new q();
al.set(-1, 0, 0, 0, 1, 0, 0, 0, 1);
function ol(e, t) {
	function n(e, t) {
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, e.envMapRotation.value.setFromMatrix4(il.makeRotationFromEuler(o)).transpose(), a.isCubeTexture && a.isRenderTargetTexture === !1 && e.envMapRotation.value.premultiply(al), e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
function ul() {
	return ll === null && (ll = new Qr(cl, 16, 16, j, v), ll.name = "DFG_LUT", ll.minFilter = c, ll.magFilter = c, ll.wrapS = r, ll.wrapT = r, ll.generateMipmaps = !1, ll.needsUpdate = !0), ll;
}
var dl = class {
	constructor(e = {}) {
		...
		let oe = 0, se = 0, I = null, ce = -1, le = null, ue = new Ut(), de = new Ut(), fe = null, pe = new Y(0), me = 0, he = t.width, ge = t.height, _e = 1, ve = null, ye = null, be = new Ut(0, 0, he, ge), xe = new Ut(0, 0, he, ge), Se = !1, Ce = new ni(), we = !1, Te = !1, Ee = new Jt(), De = new K(), Oe = new Ut(), ke = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r186"), t.addEventListener("webglcontextlost", W, !1), t.addEventListener("webglcontextrestored", at, !1), t.addEventListener("webglcontextcreationerror", ot, !1), L === null) {
				let t = "webgl2";
		...
		function rt() {
			R = new ko(L), R.init(), et = new $c(L, R), Ne = new ro(L, R, e, et), z = new Zc(L, R), Ne.reversedDepthBuffer && p && z.buffers.depth.setReversed(!0), re = L.createFramebuffer(), ie = L.createFramebuffer(), ae = L.createFramebuffer(), Pe = new Mo(L), B = new jc(), V = new Qc(L, R, z, B, Ne, et, Pe), Fe = new Oo(P), Le = new Ya(L), tt = new to(L, Le), Re = new Ao(L, Le, Pe, tt), ze = new Po(L, Re, Le, tt, Pe), Xe = new No(L, Ne, V), Ge = new io(B), Be = new Ac(P, Fe, R, Ne, tt, Ge), Ve = new ol(P, B), Ue = new Fc(), We = new Hc(R), Ye = new eo(P, Fe, z, ze, _, s), qe = new Xc(P, ze, Ne), nt = new sl(L, Pe, Ne, z), Qe = new no(L, R, Pe), $e = new jo(L, R, Pe), Pe.programs = Be.programs, P.capabilities = Ne, P.extensions = R, P.properties = B, P.renderLists = Ue, P.shadowMap = qe, P.state = z, P.info = Pe;
		}
		S !== 1009 && (N = new Io(S, t.width, t.height, o, r, i));
		let it = new rl(P, L);
		this.xr = it, this.getContext = function() {
			...
			he = e, ge = n, t.width = Math.floor(e * _e), t.height = Math.floor(n * _e), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), N !== null && N.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
		...
		function ut(e, t, n, r) {
			F !== null && e.isNodeMaterial && F.setObject(r, e), we === !0 && Ge.setState(e, n, !1), e.transparent === !0 && e.side === 2 && e.forceSinglePass === !1 ? (e.side = 1, e.needsUpdate = !0, xt(e, t, r), e.side = 0, e.needsUpdate = !0, xt(e, t, r), e.side = 2) : xt(e, t, r);
		}
		this.compile = function(e, t, n = null) {
			n === null && (n = e), F !== null && F.renderStart(e, t, n), k = We.get(n), k.init(t), M.push(k), n.traverseVisible(function(e) {
				...
				e.isLight && e.layers.test(t.layers) && (k.pushLight(e), e.castShadow && k.pushShadow(e));
			}), k.setupLights(), F !== null && F.updateLights(k.state.lightsArray), Te = this.localClippingEnabled, we = Ge.init(this.clippingPlanes, Te), we === !0 && Ge.setGlobalState(this.clippingPlanes, t), F !== null && qe.render(k.state.shadowsArray, n, t);
		...
		ht.setAnimationLoop(ft), typeof self < "u" && ht.setContext(self), this.setAnimationLoop = function(e) {
			...
			gt(e, t, 0, P.sortObjects), O.finish(), F !== null && F.updateLights(k.state.lightsArray), P.sortObjects === !0 && O.sort(ve, ye), Ae = it.enabled === !1 || it.isPresenting === !1 || it.hasDepthSensing() === !1, Ae && Ye.addToRenderList(O, e), this.info.render.frame++, this.info.autoReset === !0 && this.info.reset(), we === !0 && Ge.beginShadows();
			let i = k.state.shadowsArray;
			if (qe.render(i, e, t), we === !0 && Ge.endShadows(), (r && N.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && vt(n, r, e, t), Ae && Ye.render(e), _t(O, e, t);
			}
			...
			if (e.layers.test(t.layers)) {
				if (e.isGroup) n = e.renderOrder;
					...
					if (!e.frustumCulled || e.intersectsFrustum(Ce)) {
						...
						a.visible && O.push(e, i, a, n, Oe.z, null, t);
					}
					...
					if (r && (e.boundingSphere === void 0 ? (i.boundingSphere === null && i.computeBoundingSphere(), Oe.copy(i.boundingSphere.center)) : (e.boundingSphere === null && e.computeBoundingSphere(), Oe.copy(e.boundingSphere.center)), Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)), Array.isArray(a)) {
						...
						for (let o = 0, s = r.length; o < s; o++) {
							...
							c && c.visible && O.push(e, i, c, n, Oe.z, s, t);
						}
					} else a.visible && O.push(e, i, a, n, Oe.z, null, t);
				}
			}
			let i = e.children;
		...
		function _t(e, t, n, r) {
			...
			k.setupLightsView(n), we === !0 && Ge.setGlobalState(P.clippingPlanes, n), r && z.viewport(ue.copy(r)), i.length > 0 && yt(i, t, n), a.length > 0 && yt(a, t, n), o.length > 0 && yt(o, t, n), z.buffers.depth.setTest(!0), z.buffers.depth.setMask(!0), z.buffers.color.setMask(!0), z.setPolygonOffset(!1);
		}
		function vt(e, t, n, r) {
			...
			P.setRenderTarget(a), P.getClearColor(pe), me = P.getClearAlpha(), me < 1 && P.setClearColor(16777215, .5), P.clear(), Ae && Ye.render(n);
			let f = P.toneMapping;
			P.toneMapping = 0;
			let p = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), k.setupLightsView(r), we === !0 && Ge.setGlobalState(P.clippingPlanes, r), yt(e, n, r), V.updateMultisampleRenderTarget(a), V.updateRenderTargetMipmap(a), R.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
			...
			P.setRenderTarget(s, c, l), P.setClearColor(pe, me), p !== void 0 && (r.viewport = p), P.toneMapping = f;
		}
		function yt(e, t, n) {
		...
		function St(e) {
			if (e.uniformsList === null) {
				...
				e.uniformsList = Us.seqWithValue(t.seq, e.uniforms);
			}
		...
		function Tt(e, t, n, r, i) {
			...
			if (v.needsLights && (y.state.sunShadowMap.length > 0 && T.setValue(L, "sunShadowMap", y.state.sunShadowMap, V), y.state.directionalShadowMap.length > 0 && T.setValue(L, "directionalShadowMap", y.state.directionalShadowMap, V), y.state.spotShadowMap.length > 0 && T.setValue(L, "spotShadowMap", y.state.spotShadowMap, V), y.state.pointShadowMap.length > 0 && T.setValue(L, "pointShadowMap", y.state.pointShadowMap, V)), i.isSkinnedMesh) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Xe.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(L, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = ul()), C) {
				if (T.setValue(L, "toneMappingExposure", P.toneMappingExposure), v.needsLights && G(E, w), a && r.fog === !0 && Ve.refreshFogUniforms(E, a), Ve.refreshMaterialUniforms(E, r, _e, ge, k.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Us.upload(L, St(v), E, V);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Us.upload(L, St(v), E, V), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(L, "center", i.center), T.setValue(L, "modelViewMatrix", i.modelViewMatrix), T.setValue(L, "normalMatrix", i.normalMatrix), T.setValue(L, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.readRenderTargetPixels = function(e, t, n, r, i, a, o, s = 0) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
					...
					L.bindBuffer(L.PIXEL_PACK_BUFFER, f), L.bufferData(L.PIXEL_PACK_BUFFER, a.byteLength, L.STREAM_READ), L.readPixels(t, n, r, i, et.convert(l), et.convert(u), 0), L.bindBuffer(L.PIXEL_PACK_BUFFER, null);
					let p = I === null ? null : B.get(I).__webglFramebuffer;
					z.bindFramebuffer(L.FRAMEBUFFER, p);
					let m = L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE, 0);
					return L.flush(), await Ze(L, m, 4), L.bindBuffer(L.PIXEL_PACK_BUFFER, f), L.getBufferSubData(L.PIXEL_PACK_BUFFER, 0, a), L.bindBuffer(L.PIXEL_PACK_BUFFER, null), L.deleteBuffer(f), L.deleteSync(m), a;
				}
...
}, fl = { type: "change" }, pl = { type: "start" }, ml = { type: "end" }, hl = new Ir(), gl = new kr(), _l = Math.cos(70 * Tt.DEG2RAD), vl = new K(), yl = 2 * Math.PI, Q = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
	...
	constructor(n, r = null) {
		super(n, r), this.state = Q.NONE, this.target = new K(), this.cursor = new K(), this.minDistance = 0, this.maxDistance = Infinity, this.minZoom = 0, this.maxZoom = Infinity, this.minTargetRadius = 0, this.maxTargetRadius = Infinity, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -Infinity, this.maxAzimuthAngle = Infinity, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.keyRotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
			...
			ONE: t.ROTATE,
			TWO: t.DOLLY_PAN
		}, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._cursorStyle = "auto", this._domElementKeyEvents = null, this._lastPosition = new K(), this._lastQuaternion = new Et(), this._lastTargetPosition = new K(), this._quat = new Et().setFromUnitVectors(n.up, new K(0, 1, 0)), this._quatInverse = this._quat.clone().invert(), this._spherical = new Wa(), this._sphericalDelta = new Wa(), this._scale = 1, this._panOffset = new K(), this._rotateStart = new G(), this._rotateEnd = new G(), this._rotateDelta = new G(), this._panStart = new G(), this._panEnd = new G(), this._panDelta = new G(), this._dollyStart = new G(), this._dollyEnd = new G(), this._dollyDelta = new G(), this._dollyDirection = new K(), this._mouse = new G(), this._performCursorZoom = !1, this._pointers = [], this._pointerPositions = {}, this._controlActive = !1, this._onPointerMove = Cl.bind(this), this._onPointerDown = Sl.bind(this), this._onPointerUp = wl.bind(this), this._onContextMenu = jl.bind(this), this._onMouseWheel = Dl.bind(this), this._onKeyDown = Ol.bind(this), this._onTouchStart = kl.bind(this), this._onTouchMove = Al.bind(this), this._onMouseDown = Tl.bind(this), this._onMouseMove = El.bind(this), this._interceptControlDown = Ml.bind(this), this._interceptControlUp = Nl.bind(this), this.domElement !== null && this.connect(this.domElement), this.update();
	}
	set cursorStyle(e) {
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(fl), this.update(), this.state = Q.NONE;
	}
	pan(e, t) {
	...
	update(e = null) {
		...
		vl.copy(t).sub(this.target), vl.applyQuaternion(this._quat), this._spherical.setFromVector3(vl), this.autoRotate && this.state === Q.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
		...
		if (vl.setFromSpherical(this._spherical), vl.applyQuaternion(this._quatInverse), t.copy(this.target).add(vl), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			let e = null;
			if (this.object.isPerspectiveCamera) {
				...
				r.unproject(this.object), this.object.position.sub(r).add(t), this.object.updateMatrixWorld(), e = vl.length();
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (hl.origin.copy(this.object.position), hl.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(hl.direction)) < _l ? this.object.lookAt(this.target) : (gl.setFromNormalAndCoplanarPoint(this.object.up, this.target), hl.intersectPlane(gl, this.target))));
		} else if (this.object.isOrthographicCamera) {
	...
	_getAutoRotationAngle(e) {
		return e === null ? yl / 60 / 60 * this.autoRotateSpeed : yl / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_panLeft(e, t) {
		vl.setFromMatrixColumn(t, 0), vl.multiplyScalar(-e), this._panOffset.add(vl);
	}
	_panUp(e, t) {
		this.screenSpacePanning === !0 ? vl.setFromMatrixColumn(t, 1) : (vl.setFromMatrixColumn(t, 0), vl.crossVectors(this.object.up, vl)), vl.multiplyScalar(e), this._panOffset.add(vl);
	}
	_pan(e, t) {
		let n = this.domElement;
		if (this.object.isPerspectiveCamera) {
			let r = this.object.position;
			vl.copy(r).sub(this.target);
			let i = vl.length();
	...
	_handleMouseMoveRotate(e) {
		...
		this._rotateLeft(yl * this._rotateDelta.x / t.clientHeight), this._rotateUp(yl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd), this.update();
	}
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			case this.keys.UP:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(yl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed), t = !0;
				break;
			case this.keys.BOTTOM:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(-yl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, -this.keyPanSpeed), t = !0;
				break;
			case this.keys.LEFT:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(yl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0), t = !0;
				break;
			case this.keys.RIGHT: e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(-yl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(-this.keyPanSpeed, 0), t = !0;
		}
	...
	_handleTouchMoveRotate(e) {
		...
		let t = this.domElement;
		this._rotateLeft(yl * this._rotateDelta.x / t.clientHeight), this._rotateUp(yl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd);
	}
...
function wl(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.ownerDocument.removeEventListener("pointermove", this._onPointerMove), this.domElement.ownerDocument.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(ml), this.state = Q.NONE, this._cursorStyle === "grab" && (this.domElement.style.cursor = "grab");
			break;
		case 1:
...
function Tl(t) {
	...
	this.state !== Q.NONE && this.dispatchEvent(pl);
}
function El(e) {
	switch (this.state) {
		case Q.ROTATE:
...
function Dl(e) {
	this.enabled !== !1 && this.enableZoom !== !1 && this.state === Q.NONE && (e.preventDefault(), this.dispatchEvent(pl), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(ml));
}
function Ol(e) {
...
//#region src/tap.js
function Pl() {
	let e = /* @__PURE__ */ new Map(), t = !1, n = (e, t) => Math.hypot(t.clientX - e[0], t.clientY - e[1]);
	return {
		start(n) {
			n.button === 0 && (e.size || (t = !1), e.set(n.pointerId, [n.clientX, n.clientY]), e.size > 1 && (t = !0));
		},
		move(r) {
			let i = e.get(r.pointerId);
			i && n(i, r) > 6 && (t = !0);
		},
		end(r) {
			let i = e.get(r.pointerId), a = !!(i && !t && e.size === 1 && n(i, r) <= 6);
			return e.delete(r.pointerId), a;
		},
		cancel(n) {
			e.delete(n.pointerId), t = !0;
		}
	};
}
//#endregion
