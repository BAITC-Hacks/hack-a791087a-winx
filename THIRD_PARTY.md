...
| Документация GPT-6 Luna и reasoning | https://developers.openai.com/api/docs/models/gpt-6-luna ; https://developers.openai.com/api/docs/guides/reasoning | Документация OpenAI; ссылка, без заимствования кода | Настройка reasoning/output A1/A2 и обработка incomplete |
...
| Субагент gpt-6-luna | https://openai.com/ | Условия OpenAI | Независимое чтение ТЗ, создание части скелета, сохранение сценариев, объяснения и аудит математики/AI/UI; payload и lifecycle V1 |
| Субагент gpt-6-astra | https://openai.com/ | Условия OpenAI | Независимое ревью 3D-прототипа, жизненного цикла и интеграции U1/I1/A1/V1 |
